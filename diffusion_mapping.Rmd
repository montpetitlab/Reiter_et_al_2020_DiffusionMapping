...
Time-series RNA-sequencing captures dynamic gene expression and has revealed XXX (CITE: gash 2002 stress response, yeast cell cycle). 
...
In a previous investigation, we used brix, a proxy for sugar concentration during fermentation, to perform continuous differential expression and identified the ubiquitous transcriptome programs used by *S. cerevisiae* to accomplish Pinot noir fermentation (CITE BRIX PAPER).
Given the success of this method, we sought 
